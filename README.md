...
```
docker run --name retinanet -p 5000:5000 -p 9090:9090 -v /home/celum/DataSets/:/home/celum/DataSets xpitfire/kerasretinanet_web
```

Here we are mapping a directory directly to the docker instance.
